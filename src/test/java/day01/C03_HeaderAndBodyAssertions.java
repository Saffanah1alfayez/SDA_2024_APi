...
//        Server is "Cowboy"
        ...
        boolean isContainClarsway = responseString.contains("Clarusway");
        assertFalse(isContainClarsway); //If the boolean value between parenthesis is FALSE test will pass
